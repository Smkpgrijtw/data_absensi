...
include 'koneksi.php';
$No         = $_GET['No'];
$sql  = mysqli_query($koneksi, "select * from guru where No='$No'");
...
<style type="text/css">
	...
	<?php include 'navbar.php'; ?>
        <form method="post" action="update-edit.php">
			...
			<caption class="title">Form Edit Data Guru</caption>
				...
				<td><select name="mapel">
					<option value="<?php echo $row['mapel'];?>"><?php echo $row['mapel'];?>
                    <option value="10">10
                    <option value="11">11
					<option value="12">12
                </select> </td></tr>
                <tr><td colspan="2"><button type="submit" value="simpan">SIMPAN PERUBAHAN</button>
                        <a href="dataguru.php">Kembali</a></td></tr>
            </table>
        </form>
    </body>
</html>
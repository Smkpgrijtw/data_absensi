...
<body>
	...
	<table class="data-table">
		<caption class="title">Data Absensi Guru</caption>
		<center></center>
		<thead>
			<tr>
				<th>No</th>
		...
		if ($start_date && $end_date) {
			$sql = "SELECT masuk.tag, masuk.masuk, keluar.keluar, masuk.tanggal as tanggal_masuk, guru.nama, guru.mapel
			        FROM masuk 
			        LEFT JOIN keluar ON masuk.tag = keluar.tag AND masuk.tanggal = keluar.tanggal
			        INNER JOIN guru ON masuk.tag = guru.tag
